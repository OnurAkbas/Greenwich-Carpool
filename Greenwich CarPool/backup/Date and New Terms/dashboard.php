...
<div class="jumbotron text-center" style="margin-bottom: -60px;">
  ...
  <label for="comment">Leave a comment on your recent Journey:</label>
   ...
   <button style="margin-left: 1100px;" id="btn4" value="Button 4" class="btn btn-warning" name='btn_submit' type="submit">EDIT!</button>
   <?php }else { ?>
   <textarea class="form-control" rows="1" cols="100" id="comment" name="comment" maxlength="100"></textarea>
   <button style="margin-left: 1100px;" id="btn1" value="Button 1" class="btn btn-success" name='btn_submit' type="submit">Submit!</button> 
   <?php }
   ?>
      <?php
