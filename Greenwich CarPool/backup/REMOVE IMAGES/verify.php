...
<div class="jumbotron text-center">
  ...
  <form class="form-inline" method="post" >
    ...
    <div>
    <label style="padding-right: 7px"> Username Name : <?php echo "$usernamee"; ?> </label>
  ...
  <?php   //mysql Verifcation System
        ...
        if($result)
        {
            ...
            if($count == 1)
			{
             ...
             echo "<h3>" . "Your Verifcation doesn't match your Username, Please Check your Email. or Resend if you haven't received it." . "</h3>";
            }
            }
