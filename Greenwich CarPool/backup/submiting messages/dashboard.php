...
<div class="jumbotron text-center" style="margin-bottom: -60px;">
  ...
  <textarea class="form-control" rows="3" cols="100"id="comment" name="comment" ></textarea>
  <button style="margin-left: 700px;" id="btn1" class="btn btn-success" for="comment" name="submit" type="submit">Submit!</button>
