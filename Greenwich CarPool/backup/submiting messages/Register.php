...
<div class="jumbotron text-center">
  ...
  <form class="form-inline" method="post" >
    ...
    <div>
    <label style="padding-right: 80px">Captcha</label>
    <div class="input-group" style="padding-bottom: 0px">
    <label style="padding-left: 0px"> <?php echo $num1 = rand(0,10)." + ".$num2 = rand(0,10)."?";
    $add = ($num1 + $num2);
    $_SESSION['totalsum'] = $add; 
    ?>
    </label>   <lable style="padding-right: 10px"> = </lable> <font color="red">
    ...
    <input type="checkbox" class="form-check-input" name="cbconfirm" value="confirm">
      Please Tick the box, once you have agreeed to the <a href="terms.html" target="_blank"> <font color="red"> Terms and Condition.</font></a>
    </label>
    </div>
        
        <a href="YOUR_URL" Title</a>
    </div>
