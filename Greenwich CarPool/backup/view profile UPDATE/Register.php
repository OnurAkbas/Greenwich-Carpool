...
<div class="jumbotron text-center">
  ...
  <form class="form-inline" method="post" >
    ...
    <h5 style="padding-left: 0px"> <font face="verdana"> <?php echo "<i>" . $num1 = rand(10,50)." + ".$num2 = rand(10,50)."</i>" . " =  ";
    $add = ($num1 + $num2);
    $_SESSION['totalsum'] = $add; 
    ?>
    </font></h5>
    <input type="text" size="15" color="black" placeholder="Are you a Robot" id="Captcha" name="Captcha" maxlength="100" required> 
    </div>
    </div>
